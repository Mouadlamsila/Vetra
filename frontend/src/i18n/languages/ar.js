...
const ar = {
  ...
  header: {
    ...
    searchPlaceholderFull: "البحث عن المتاجر، المنتجات...",
  },
  checkout: {
    title: 'الدفع',
  ...
  search: {
    ...
    resultsFoundFor: "نتائج وجدت لـ",
    noResultsFound: "لم يتم العثور على نتائج",
    noResultsFoundFor: "لم يتم العثور على نتائج لـ",
    tryAdjusting: "حاول تعديل كلمات البحث أو الفلاتر",
    ...
    famousSearches: "عمليات البحث الشهيرة",
    back: "رجوع",
    loading: "جاري التحميل...",
    error: "خطأ",
