  ...
  modals: {
    ...
    confirm: {
      ...
      disable: {
        ...
        message: "هل أنت متأكد من تعطيل المتجر \"{{name}}\"؟ لن يكون مرئياً في المنصة."
      },
      enable: {
        title: "تأكيد تفعيل المتجر",
        message: "هل أنت متأكد من تفعيل المتجر \"{{name}}\"؟ سيكون مرئياً مرة أخرى في المنصة."
      },
      reject: {
        title: "تأكيد الرفض",
