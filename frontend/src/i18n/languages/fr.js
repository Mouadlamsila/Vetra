...
const fr = {
  ...
  sessionCreationError: "Échec de la création de session pour l'utilisateur existant",
  authenticationDataError: "Échec de l'obtention des données d'authentification",
  ...
  header: {
    ...
    searchPlaceholderFull: "Rechercher des boutiques, produits...",
  },
  checkout: {
    title: 'Paiement',
  ...
  search: {
    ...
    famousSearches: "Recherches populaires",
    back: "Retour",
    loading: "Chargement...",
    error: "Erreur",
    tryAgain: "Réessayer",
