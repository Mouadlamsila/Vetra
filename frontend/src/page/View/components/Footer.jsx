      ...
      <div className="container px-4 sm:px-15 mx-auto px-4 py-12">
        <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              />
              <button className="w-full bg-purple-700 hover:bg-purple-800 text-white py-2 px-4 rounded-md cursor-pointer">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <div className="flex items-center gap-4">
           ...
           <FaPaypal className="h-6 w-6 text-purple-400 cursor-pointer" />  
           </Link>
          </div>
        </div>
      </div>
