...
export default function DesignStore() {
    ...
    useEffect(() => {
        const fetchStoreData = async () => {
            try {
                const response = await axios.get(`https://useful-champion-e28be6d32c.strapiapp.com/api/boutiques/${id}`);
                ...
                const productsResponse = await axios.get(
                    `https://useful-champion-e28be6d32c.strapiapp.com/api/products?filters[boutique][documentId][$eq]=${id}`
                );
    ...
    const handleSave = async () => {
        try {
            await axios.put(`https://useful-champion-e28be6d32c.strapiapp.com/api/boutiques/${id}`, {
                data: {
                    nom: formData.name,
