import { Check, ChevronLeft, ChevronRight, Earth, Globe, Settings, Store, User, UserPlus } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-5">
                <div className="space-y-3 max-w-2xl mx-auto lg:mx-0">
                    <div className="flex items-center gap-4">
                        <h1 className="sm:bg-[#6D28D9] flex  w-8 h-8 sm:w-12 sm:h-12 sm:rounded-[50%] text-[#6D28D9] sm:text-white items-center  justify-center text-4xl sm:text-xl">1</h1>
