                ...
                <div className="space-y-3 max-w-2xl mx-auto lg:mx-0">
                    ...
                    <div className="space-y-4">
                        <div className="flex gap-4 sm:gap-5 items-start">
                            ...
                            <div>
                                <h1 className="text-base sm:text-lg font-medium">{t('easyProductAddition')}</h1>
                                <h1 className="text-base sm:text-lg text-gray-500">{t('easyProductAdditionDesc')}</h1>
                            </div>
                        </div>
                        <div className="flex gap-4 sm:gap-5 items-start">
                            <div className="text-[#6D28D9] rounded-[50%] bg-[#c8c2fd] w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 flex justify-center items-center">
                            ...
                            <div>
                                <h1 className="text-base sm:text-lg font-medium">{t('categoryOrganization')}</h1>
                                <h1 className="text-base sm:text-lg text-gray-500">{t('categoryOrganizationDesc')}</h1>
                            </div>
                        </div>
                        <div className="flex gap-4 sm:gap-5 items-start">
                            <div className="text-[#6D28D9] rounded-[50%] bg-[#c8c2fd] w-8 h-8 sm:w-10 sm:h-10 flex-shrink-0 flex justify-center items-center">
                            ...
                            <div>
                                <h1 className="text-base sm:text-lg font-medium">{t('deliveryOptions')}</h1>
                                <h1 className="text-base sm:text-lg text-gray-500">{t('deliveryOptionsDesc')}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div className="flex w-full justify-center items-center">
                    <div className="bg-white shadow-2xl p-4 sm:p-6 rounded-xl w-full max-w-md">
                        <div className="flex w-full justify-between pb-4">
                            <h1 className="text-xl sm:text-2xl font-medium">{t('productManagement')}</h1>
